...
public class SendComplaintController {
	...
	@FXML
	private TextField complaintInfo;
	@FXML 
	...
	void toDo(ActionEvent event) throws JSONException, IOException {
		...
		String _complaintInfo = complaintInfo.getText();
        boolean status = false;
        String response;

      		try {
      	          
      	          URL url = new URL("http://"+myIp+":"+myPort+"/myProject/SendComplaint");
     	          ...
     	          params.put("complaintInfo", _complaintInfo);
