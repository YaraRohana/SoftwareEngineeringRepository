...
/**
 * Servlet implementation class UnsetFaultedParkingSpot
 */
@WebServlet("/UnsetFaultedParkingSpot")
public class UnsetFaultedParkingSpot extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UnsetFaultedParkingSpot() {
        super();
